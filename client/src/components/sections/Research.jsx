    ...
    <section id="research" className="py-28 border-t border-white/[0.08] text-left select-none relative">
      <div className="space-y-12">
        ...
        <div className="flex items-center space-x-4">
          <h2 className="text-3xl font-bold tracking-tight text-white font-heading">Research & Publications</h2>
          <div className="h-[1px] bg-gradient-to-r from-white/20 to-transparent flex-grow" />
        </div>

        {/* Papers Timeline Grid */}
        <div className="relative border-l border-white/10 ml-6 md:ml-8 pl-8 md:pl-10 space-y-12 py-2">
          {papers.map((paper, index) => (
            <Reveal key={paper._id} delay={index * 0.08}>
              <div className="relative group/timeline">
                
                {/* Timeline node year bubble */}
                <div className="absolute top-2 -left-[54px] md:-left-[58px] translate-x-[-50%] flex flex-col items-center z-10">
                ...
                <div 
                  ...
                  className="group cursor-pointer p-8 rounded-2xl border border-white/[0.08] bg-[#101010]/80 backdrop-blur-md hover:border-white/30 hover:shadow-[0_20px_45px_rgba(249,115,22,0.06)] transition-all duration-400 relative overflow-hidden"
                >
                  ...
                  <div className="absolute top-3 right-4 text-[7px] font-mono text-gray-500 tracking-widest uppercase select-none">
                  ...
                  <div className="flex flex-col md:flex-row md:items-start justify-between gap-6 pl-4">
                    ...
                    <div className="space-y-4 flex-1">
                      <div className="space-y-2">
                        <div className="flex items-center gap-1.5 text-[10px] font-mono text-white uppercase font-bold tracking-widest">
                          <BookOpen className="w-3.5 h-3.5 text-white" />
                          <span>Published in {paper.year}</span>
                        </div>
                        
                        <h3 className="text-xl font-extrabold text-white group-hover:text-white transition-colors flex items-center justify-between font-heading leading-snug">
                          <span>{paper.title}</span>
                          <ArrowUpRight className="w-5 h-5 text-gray-550 group-hover:text-white transition-colors shrink-0" />
                        </h3>
                      ...
                      <div className="space-y-1">
                        <p className="text-[10px] font-extrabold tracking-widest text-gray-500 uppercase font-mono">Abstract Summary</p>
        ...
        {/* Beautiful Research Dialog Modal */}
        <AnimatePresence>
          {selectedPaper && (
              ...
              >
                ...
                <div className="space-y-2 text-left">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-mono text-gray-500">• Published in {selectedPaper.year}</span>
                  </div>
                ...
                <div className="space-y-2 pt-4 border-t border-white/[0.04] text-left">
                  <p className="text-[10px] font-extrabold uppercase tracking-widest text-gray-550 font-mono">Abstract Overview</p>
