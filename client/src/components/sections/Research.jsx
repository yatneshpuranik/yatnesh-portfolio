          ...
          {papers.map((paper, index) => (
            <Reveal key={paper._id} delay={index * 0.08}>
              <div 
                ...
                className="group cursor-pointer p-8 rounded-2xl border border-white/[0.08] bg-[#101010]/80 backdrop-blur-md hover:border-white/30 hover:shadow-[0_20px_45px_rgba(0,0,0,0.8)] transition-all duration-400 relative overflow-hidden"
              >
